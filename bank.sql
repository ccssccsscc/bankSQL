...
-- Script date 15/11/2023 15:28:49
...
CREATE DATABASE IF NOT EXISTS fc2
...
FUNCTION IF NOT EXISTS GetTotalReviewCount ()
RETURNS int(11)
DETERMINISTIC
BEGIN
...
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS GetAverageRating ()
RETURNS decimal(3, 2)
DETERMINISTIC
BEGIN
...
CREATE
DEFINER = 'root'@'localhost'
PROCEDURE IF NOT EXISTS UpdateReview (IN in_review_code int,
IN in_comment text,
...
CREATE
DEFINER = 'root'@'localhost'
PROCEDURE IF NOT EXISTS ChangeGender (IN in_client_code int,
...
--
CREATE TABLE IF NOT EXISTS visit_to_fitness_club (
...
CREATE
DEFINER = 'root'@'localhost'
PROCEDURE IF NOT EXISTS DeleteVisit (IN in_visit_code int,
...
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS GetMonthlySubscriptionCostForClient (in_client_code int)
...
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS GetActiveSubscriptionsForClient (in_client_code int)
...
--
INSERT INTO review(review_code, comment, date_written, time_written, rating) VALUES
...
--
INSERT INTO subscription_type(subscription_code_type_code, type) VALUES
(1, 'Basic'),
(2, 'Premium'),
(3, 'Gold');
...
--
INSERT INTO client(client_code, first_name, last_name, email, address, age, phone, review_code, gender) VALUES
...
--
INSERT INTO specification(specification_code, specification_name) VALUES
(1, 'Cardio'),
(2, 'Strength training'),
(3, 'Yoga'),
(4, 'Pilates'),
...
--
INSERT INTO visit_to_fitness_club(visit_code, client_code, date, start_time, end_time) VALUES
...
--
INSERT INTO subscription(subscription_code, number_of_classes, price, duration, client_code, subscription_code_type_code, start_date, end_date) VALUES
...
--
INSERT INTO coach(coach_code, specification_code, Name) VALUES
(1, 1, 'Coach 1'),
(2, 2, 'Coach 2'),
(3, 3, 'Coach 3'),
(4, 4, 'Coach 4'),
...
--
INSERT INTO classes_type(type_code, type_name) VALUES
(1, 'Cardio'),
(2, 'Strength training'),
(3, 'Yoga'),
(4, 'Pilates'),
...
--
INSERT INTO subscription_options(subscription_code, client_code, info_about_subs) VALUES
...
--
INSERT INTO class(class_id, type_code, description, time, status, subscription_code, client_code, visit_code, coach_code) VALUES
...
CREATE
DEFINER = 'root'@'localhost'
TRIGGER IF NOT EXISTS before_insert_time
BEFORE INSERT
ON review
FOR EACH ROW
BEGIN
...
CREATE
DEFINER = 'root'@'localhost'
TRIGGER IF NOT EXISTS before_insert_review
BEFORE INSERT
ON review
FOR EACH ROW
...
CREATE
DEFINER = 'root'@'localhost'
TRIGGER IF NOT EXISTS before_insert_client
BEFORE INSERT
ON client
FOR EACH ROW
BEGIN
